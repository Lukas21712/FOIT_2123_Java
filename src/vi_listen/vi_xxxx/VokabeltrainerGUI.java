...
public class VokabeltrainerGUI extends JFrame {
                ...
                addSaveButton.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if (germanInput.isEmpty() || englishInput.isEmpty()) {
                            ...
                            listGerman(german, new File("/FOIT_2123_Java/src/vi_listen/vi_xxxx/germanGUI.txt"));
                            english.add(addEnglishField.getText());
                            listEnglish(english, new File("/FOIT_2123_Java/src/vi_listen/vi_xxxx/englishGUI.txt"));
    ...
    public static void main(String[] args) {
        VokabeltrainerGUI myFrame = new VokabeltrainerGUI();
    }

    private static void listGerman(List list, File datei){
    ...
    private static void listEnglish(List list, File datei){
        PrintWriter printWriter = null;
        try {
            printWriter = new PrintWriter(new FileWriter(datei));
            Iterator iter = list.iterator();
